...
Run:  uv run python pipeline/export_cma_site.py            # add new issuances
      uv run python pipeline/export_cma_site.py --rebuild  # rewrite everything
"""
...
def main() -> None:
    ...
    (fdir / "index.json").write_text(json.dumps(index, separators=(",", ":")))
