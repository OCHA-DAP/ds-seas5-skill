...
- **West Nile is unimodal in ASAP** (no second-season crops): planting March
  ...
  below). That points to a season close to normal in water terms, with the
...
### Season-to-date: has the season's water actually arrived?

Monthly percentiles say when it was dry; they do not say how much of the
season's total water has arrived. The curves below accumulate rainfall over
each zone's own calendar window (planting start to harvest end; Karamoja's
Apr-Sep wet season from the ERA5 climatology) and compare 2026 against every
year since 1981. Two different stories emerge. **Karamoja has received
...
this observed season-to-date figure with the deficit map above, which is the
*forecast* for the worst upcoming slot.) The bimodal zones sit in between at
roughly 65-99%.
