...
- **West Nile corridor: a harvest already lost.** The refugee-hosting
  districts sit at 55-79% of normal in a zone with no second season, so the
  food gap runs until the March 2027 planting. A response exists here but
  targets well under the JIAF caseload; the question is depth and duration of
  assistance, not whether to start.
...
rows = [
    ...
    ("West Nile corridor", [
        (X["Aug"], X["Mar"] + 1, "#e69f00", 0.30, "food gap after the failed Jun-Jul harvest"),
